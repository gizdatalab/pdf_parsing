![](assets_AuditReports%5CMW&T%5CMW&T%5CURC%20WTS_VFM_AGCY_2019_20_1646212180/img-0512.jpg)
...
In accordance with the Uganda Corporation Act, Cap. 331 of the laws of Uganda, the overall objective of Uganda Railways Corporation is to undertake the construction of railway, marine and road services both inside and outside Uganda for the carriage of goods and passengers. In addition, the Corporation is mandated to carry out, subject to the Act, any such activities that are conducive or incidental to the attainment of its main objective.

To achieve this mandate, the URC planned to implement a number of both recurrent and development deliverables under various departments. For the year under review, the Corporation had an approved revenue budget of UGX.100.38 Bn of which UGX.14.8 Bn was realized as revenue.

From the procedures undertaken, the following was noted:

| **No** | **Observation** | **Recommendation** |  
|---|---|---|  
| **5.1** | **Implementation of the strategic plan** overall Government National Development Plan (NDP II) expired at the end of FY 2019/20. In line with the NDP II, the URC had an approved strategic plan for the period 2016/2017 -2020/21, which set out both the long term and short term targets to be achieved during the duration of the strategic plan. This being the 2 nd last year of implementation of the URC’s strategic plan, I undertook an assessment of the achievement of the Corporations’ strategic targets/goals. noted that at the time of the audit (June 2020), out of the planned five (5) strategic targets/goals, no target had been fully achieved; all the five (5) were partially achieved as summarized in Table 5 below. I The | advised the Accounting Officer to devise a strategy of increasing the passenger  train coaches,  goods routes, and also engage the business community  for increased carriage. I |  


---

| **Table 5: Extent of achievement of 2016/2017-2020/2021 strategic plan** **No Level of performance by the end of 2019/2020** **No of strategic** **goals/** objectives** **% of total number of strategic objectives** 1 2 3 Fully achieved Partially achieved Not achieved **Total** 0 05 0 **05** 100 0 0 **100** Accounting Officer explained that the underperformance was due to the business community perception about railway transport which is worsened by the poor state of the Meter Gauge rail network, rampant vandalism of rail-slippers which result into delayed deliveries, train accidents, high levels of obsolete and dilapidated machinery and buildings respectively that are not generating revenue. addition, the COVID-19 pandemic lock downs halted the passenger city service train for over 8 months (March– November 2020). The overall effect was low internally generated revenue. The trend was worsened by the failure to timely absorb the meagre Central Government support to URC. These combined led to low revenue realization which continued to impair the Corporation’s ability to meet its differed maintenance projection of its assets so as to raise enough revenue to fully support its operations. The In |<|<|<|<|<|<||  
|---|---|---|---|---|---|---|---|  
|^|<|<|<|<|<|<|^|  
|^|<|<|<|<|<|<|^|  
|^|<|<|<|<|<|<|^|  
...
|^|<|<|<|<|<|<|^|  
|^|<|<|<|<|<|<|^|  
| **5.2 Revenue Performance of NTR** reviewed the NTR estimates, revenue sources and rates charged at the entity for the financial year 2019/2020 and noted that the entity budgeted to collect NTR of UGX.100.38BN during the year under review. Out of this, only UGX. 14.8 Bn was collected, representing a performance of 14.7% of the target. **of GoU receipts** entity budgeted to receive UGX.53.5 Bn out of which a total of UGX.7.8 Bn was warranted, resulting in a shortfall of UGX. 45.7 Bn which is 85% of the budget. Revenue shortfalls affect the implementation of planned activities. Accounting Officer explained that the underperformance was due to accidents caused by the poor state of the meter-gauge railway line in both Kenya and Uganda which costed the Corporation an estimated USD.700,000 in revenue and the Covid 19 pandemic which led to a lockdown between Mid-March to early November 2020. This paralyzed transport further contributing to about 38,000 MT in lost revenue, and; encroachment/theft of assets, among others. I **Performance** **Performance** The The |<|<|<|<|<|<| KRC advised the Accounting Officer to continue liaising with  in undertaking preventive maintenance on the rail and increase the security of URC assets to curb theft and encroachment. also advised the Accounting officer to engage  GOU (MoFPED)  for increased funding. I I |  
|^|<|<|<|<|<|<|^|  
|^|<|<|<|<|<|<|^|  
|^|<|<|<|<|<|<|^|  
| 14.1.16 of the URC Financial Accounts Manual, 2007 provides that activities not catered for in the budget shall require a special approval by the Management Committee and the Board. of the total receipts for the financial year of UGX.22.99 Bn, UGX.34.94 **5.3 Absorption of funds** Paragraph Out |<|<|<|<|<|<| I advised the Accounting Officer to adhere to the budget provisions and deliver planned outputs as planned. |  
|^|<|<|<|<|<|<|^|  


---

|| Bn was incurred by the Corporation resulting into an excess expenditure of UGX.12 Bn representing an absorption level of 152%. Refer to **Table 6** below; **6: Absorption of funds** **Year 2019/20** **APP EST** (A) (UGX billions)** **(B)** **RECEIP** **TS** (UGX billions)** 22.6 stifle its operations. **Expenditure** **(C)** billions)** **(UGX** **Excess (B-C)** **(UGX** billions)** **% absorption** 34.94 (12) 152.4% 153.9  resulted in the accumulation of domestic arrears which will further Accounting Officer explained that this was mainly due to the commitment system derived from the accrual accounting system, and credit facilities derived from the Corporation’s account payables thus leading to accumulation of domestic arrears/payables. **Table** This The |<|<|<|<|<|<| I also advised the Accounting Officer to engage GOU (MoFPED)  for increased Government funding support. |  
|---|---|---|---|---|---|---|---|---|  
| **Year 2019/20** |^|<|<|<|<|<|<|^|  
| **APP EST (A) (UGX billions)** |^|<|<|<|<|<|<|^|  
| 153.9 |^|<|<|<|<|<|<|^|  
| stifle its operations. resulted in the accumulation of domestic arrears which will further Accounting Officer explained that this was mainly due to the commitment system derived from the accrual accounting system, and credit facilities derived from the Corporation’s account payables thus leading to accumulation of domestic arrears/payables. This The |^|<|<|<|<|<|<|^|  
| **5.4** | **Quantification of outputs** 55 of the budget execution circular for the financial year 2019/2020 states that the Accounting Officer is required to submit quarterly performance reports by the 30 th day of the first month of the next quarter. These reports should indicate the actual performance against the planned outputs and performance for each quarter, showing the quantity/quality and physical location of the reported outputs against expenditure. of the ten (10) outputs with a total of thirty-five (35) activities and expenditure of UGX.9.3 Bn sampled for assessment, I reviewed the extent of quantification of outputs and activities and noted the following; Five (5) outputs with a total of eighteen (18) activities and expenditure worth UGX.0.507 Bn were fully quantified. That is, all the eighteen (18) activities (100%) within these outputs were clearly quantified to enable assessment of performance.  Three (3) outputs with a total of fifteen (15) activities and expenditure worth UGX.8.84 Bn were insufficiently quantified. I observed that out of the fifteen (15) activities, eight (8) activities (53.3%) were quantified while seven (7) activities (46.7%) were not clearly quantified to enable assessment of performance.  Two (2) outputs with a total of two (2) activities were not quantified at all. That is, all the two (2) activities within these outputs were not clearly quantified to enable assessment of performance. to **Table 7** below for a summary of extent of quantification and amounts spent.  Paragraph Out Refer |<|<|<|<|<|<| I advised the Accounting Officer to ensure that there is  sufficient quantification of all outputs and their activities to enable efficient monitoring and  budget performance assessment. further advised the Accounting Officer to equip the Planning Unit with the  necessary human resources to enable it undertake proper planning. I |  


---

| **Table 7: Extent of Quantification by activities** **Summary of Performance by Outputs** Activity details-Analysis** Category of outputs Fully quantified outputs Insufficiently quantified outputs Outputs not quantified **% of total out- puts samp led** **Expe nditu re UGX Bn** **% propo rtion to total expe nditu re** **No. of out put** **s** sa mpl ed** 5 50 0.507 5.4 18 18 **Total no of activi** **ties** in the outp uts** **No.** of Fully Quan tified activi ties** **No. of activiti es not fully quantif ied** **%** of quantificat** **ion** of activities per** **category** of output** 3 30 8.83 94.5 15 8 2 20 0 0 2 0 0 7 2 100 53 0 Total **10 100 9.34 100 35 26 9** observed that in cases where outputs were either partially or not quantified, management reported performance in generic ways such as boundary markers erected without specifying the number of boundary markers erected. to plan and report on the quality/quantity of activities implemented renders it difficult to establish the reasonableness of individual activity costs for each planned output which curtails effective accountability when funds are subsequently spent. Further, without clearly and fully quantified outputs, I could not ascertain the level of achievement of these outputs and whether funds appropriated by both URC Board, Minister, and Parliament (for Government support) released to the Corporation were spent appropriately and the intended objectives achieved. explained that this was due to planning and budgeting gaps within the Corporation. The Planning Unit is in its infancy stage and inadequately staffed. I Failure Management |<|<|<|<|<|<|<|<|<|<|<||  
|---|---|---|---|---|---|---|---|---|---|---|---|---|  
|^|<|<|<|<|<|<|<|<|<|<|<|^|  
|^|<|<|<|<|<|<|<|<|<|<|<|^|  
|^|<|<|<|<|<|<|<|<|<|<|<|^|  
...
|^|<|<|<|<|<|<|<|<|<|<|<|^|  
|^|<|<|<|<|<|<|<|<|<|<|<|^|  
| **5.5 Implementation of quantified outputs** assessed the implementation of Five (5) outputs that were fully quantified with a total of eighteen (18) activities worth UGX 0.507Bn and noted the following; The entity did not fully implement any output over the FY 2019/2020. One (1) output with a total of two (2) activities worth UGX 0.507Bn was partially implemented. The entity implemented both activities partially. Four (4) outputs with a total of sixteen (16) activities worth were not implemented at all. That is the entity did not implement all the sixteen (16) activities (0%) within the outputs. to **Table 8** for a summary of the extent of implementation and amounts spent. I    Refer |<|<|<|<|<|<|<|<|<|<|<| I advised the Accounting Officer to ensure that internally generated revenue  is accurately budgeted for and followed up for collection and to follow up with the relevant authorities to adequate GOU funding support. |  
|^|<|<|<|<|<|<|<|<|<|<|<|^|  


---

| **Extent of implem entatio n of activiti** **es** per categor y of output** 0 0 0 **8 Showing level of implementation of Fully Quantified** **Total no of activi ties** **% propo rtion to total expe nditu re** **No. of Fully imple ment ed activit ies** **No. Of parti ally impl eme nted activ ities** **No. of activi ties that were not imple ment ed** **Expendi ture UGX** **% of impl eme ntati on** **No of outp uts** Summary of Performance by Output  Activity details-Analysis **outputs** Category of output 0 0 0 20 0.507 70 0 2 0 0 0 2 0 0 60 0 0 16 0 0 16 0 1 4 Fully  implement  ed outputs  Partially  Implemen  ted  outputs  Outputs  Not  Implemen  ted  Total **5 100 0.507 70 18 0 2 16** Non-implementation of planned activities implies that the expected services to the beneficiary communities were not attained. For example, the entity did not procure 2 pool vehicles, one tipper, two mini buses, and did not erect a fence over Kampala headquarter land, among others. Details in **Appendix II.** Accounting Officer explained that failure to implement all planned activities and outputs fully was due to the Covid 19 pandemic lockdown effect and low realization of funds both internal and GoU support. **Bn** **Table** The |<|<|<|<|<|<|<|<|<|<|<||  
|---|---|---|---|---|---|---|---|---|---|---|---|---|  
|^|<|<|<|<|<|<|<|<|<|<|<|^|  
|^|<|<|<|<|<|<|<|<|<|<|<|^|  
|^|<|<|<|<|<|<|<|<|<|<|<|^|  
...
|^|<|<|<|<|<|<|<|<|<|<|<|^|  
|^|<|<|<|<|<|<|<|<|<|<|<|^|  
| **5.6** Accuracy of Performance reports submitted** 55 of the budget execution circular for the financial year 2019/2020 states that the Accounting Officer is required to submit quarterly performance reports by the 30 th day of the first month of the following quarter. These reports should clearly indicate the actual performance against the planned outputs and performance for each quarter, showing the quantity/quality and physical location of the reported outputs against expenditure. my review of the annual cumulative performance reports and physical inspections/verification of performance, I noted that whereas departments prepared quarterly performance reports, and annual performance report prepared by the Corporation, most of the planned outputs were reported on in generic form. This made proper assessment of performance difficult. No explanation was given for this anomaly. Paragraph From |<|<|<|<|<|<|<|<|<|<|<| I advised the Accounting Officer to ensure that all planned outputs are accurately reported on in the annual performance report to enable effective assessment  of budget  performance. |  
|^|<|<|<|<|<|<|<|<|<|<|<|^|  
...
Management did not assess the impairment of assets despite the existence of impairment indicators. For instance, rental properties were being charged below market value where some tenants were paying UGX.5,000 per month for rentable houses. In addition, the revaluation and assessment report dated April 2018 indicated a number of assets such as cranes, civil engineering equipment, wagons and locomotives that were physically damaged and required major repairs, overhaul and decommissioning, thus emphasizing the need for impairment.

Non- recognition of impairment loss overstates non–current assets and understates expenditure.

The Accounting Officer explained that this exercise was started and a Board of Survey was also set up during the year 2019/2020. He further explained that this exercise progressed slowly because of the pandemic; this will be completed in the year 2020/21.

I advised the Accounting Officer to ensure that all the non-current assets are assessed and presented at the correct carrying values.

**7.0**

### Long outstanding Withholding Tax receivable - UGX 1,005,358,000

Under Note 12 to the Statement of Financial Position as of 30 June, 2020 is a Withholding Tax (WHT) receivable of UGX.1,005,358,000 under trade and other receivables as an amount relating to withholding tax recovered by other companies on transactions undertaken with URC. Whereas URC has tax certificates and evidence of application for a refund of these taxes submitted to URA, the amount still remains outstanding with no correspondences from the tax body.

This raises uncertainty on the recovery of the funds in question.
...
Absence of vehicle log books makes it difficult for Management to track fleet movements, fuel usage, and maintenance expenditures. This in turn may lead to fleet misuse and misappropriation of allocated fuel for unauthorized purposes.

## 12.4 Support to Entity Service Delivery

I advised the Accounting A review of the vehicle allocation to key service centres in the Officer to plan to have Corporation revealed that some departments or units were not adequate number of adequately allocated vehicles.

## The Table below refers

### Unit/ No. of Type of Are Reasons Effects Department vehicl vehicles allocated for requiring es allocated vehicles inadequat vehicles allocat adequate e ed and allocation

vehicles for service delivery for effectiveness in operations.

---

| verify progress of the projects being paid for. in in of Delays  supervision mechanical operations  different stations. Un timely response in undertaking the required repairs of the Meter Gauge Railway. **Mechanical**  1 **Civil**  5 **Managing Director** **Operations - CS** 1 1 No No Lack  of adequate funding Lack  of adequate funding Yes  N/A Yes  N/A Pick-up double cabin Lorry- Mitsubishi Tipper- Hino Pickup- Double cabin Land cruiser- Prado Land cruiser- Prado allocation of vehicles to the above departments/units deprives efforts of ensuring timely execution thus affecting the level of service delivery  the URC planned interventions. in regard to Inadequate |<|<|<|<|<|<|<|<|<||  
|---|---|---|---|---|---|---|---|---|---|---|  
|^|<|<|<|<|<|<|<|<|<|^|  
|^|<|<|<|<|<|<|<|<|<|^|  
|^|<|<|<|<|<|<|<|<|<|^|  
...
|^|<|<|<|<|<|<|<|<|<|^|  
|^|<|<|<|<|<|<|<|<|<|^|  
| to advised the Accounting officer to engage key stakeholders  secure funds for overhauling the URC operations fleet, for adequate service delivery. I **12.5 Adequacy of Vehicle Maintenance funding** 14.1.7 of the Financial Accounting Manual 2007 requires individual departments to make budget estimates as per activities documented in their work plan for the period. review of the approved work plan and budget revealed that the entity made budget provisions for vehicle maintenance during the period under review. The entity realized and spent a total of UGX.207,841,165 against the vehicle maintenance budget of UGX.164,000,000 for the 2 FYs 2018/19 – 2019/20 reflecting excess spending of UGX.43,841,165, which is an increment of 26% of the budgeted vehicle asset maintenance funds, as indicated **Table** below: **of vehicle maintenance** **Vehicle Maintenanc e Budget (A) (UGX)** 47,000,000 117,000,000 **of** **entity** **No. operationa** **l** motor Vehicles** **(B)**  15 13 **Amount spent (C) (UGX)** **Variance (A- C) (UGX)** **Average**  **spendin**  **g per**  **vehicle**  **(C/B)**  **(UGX)**  98,153,793 6,543,586 (51,153,793) 109,687,372 8,437,490 7,312,628 **164,000,000 207,841,165 (43,841,165 )** The Corporation had a vehicle maintenance budget provision of UGX.47,000,000 for 15 vehicles in FY 2018/19 but actually spent UGX.98,153,793. This gave an average maintenance expenditure cost of UGX.6,543,586. In FY 2019/2020, URC budgeted to maintain 13 vehicles at UGX.117,000,000 and actual expenditure was UGX.109,687,372 which resulted into an average maintenance cost of UGX.8,437,490. The repair expenditure revealed an increasing trend. A **FY** **2018 /19 2019 /20** Total Section **Cost** |<|<|<|<|<|<|<|<|<|<|  
|^|<|<|<|<|<|<|<|<|<|<|  
|^|<|<|<|<|<|<|<|<|<|<|  
|^|<|<|<|<|<|<|<|<|<|<|  
|^|<|<|<|<|<|<|<|<|<|<|  
...
### Staff working beyond mandatory retirement
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|  
| Mechanical | 312201 Rolling stock | Rehabilitatio n/lease of locos | yes | Lease of two high capacity locomotive s | 2,214,586 | nil | nil | 0 | No loco was leased. . | Two high capacity locomotiv es were not leased. This was not undertak en | Not implemented | No. No monitoring reports were availed to audit. | yes ||  
| Mechanical |^| Rehab ferry | yes | One ship MV Umoja rehabilitat ed | 22,800,000 | nil | nil | 0 | it was not undertaken | One ship MV Umoja rehabilita ted, not undertak en | Not implemented | No. No monitoring reports were availed to audit. | No. The output was not reported on in the Annual performance report ||  
...
|| Kyengera passenger service opened. |||||| passenge r service opened. This was not undertak en - Kyengera |||||  
|---|---|---|---|---|---|---|---|---|---|---|---|  
| Mechanical | 312202 Machine ry and equipme nt | Breakdown crane | yes | One break down crane refurbishe d | 316,667 | nil | nil | 0 | it was not undertaken | One break down crane refurbish ed. This was not undertak en. | Not implemented | No. No monitoring reports were availed to audit. | No. The output was not reported on in the Annual performance report ||  
| Mechanical |^| Container cranes | yes | one container crane purchased | 1,140,000 | nil | nil | 0 | it was not undertaken | one container crane purchase d. This was not undertak en. | Not implemented | No. No monitoring reports were availed to audit. | No. The output was not reported on in the Annual performance report ||  
| Civil |^| Purchase of generator and Floodlights | yes | One generator purchased | 13,000 | nil | nil | 0 | it was not undertaken | One generator purchase d. This was not undertak en. | Not implemented | No. No monitoring reports were availed to audit. | No. The output was not reported on in the Annual performance report ||  
| Mechanical |^| Tools | No | Various workshop tools purchased | 31,013 | nil | nil | 0 | it was not undertaken | Various workshop tools purchase d. This was not undertak en. | Not implemented | No. No monitoring reports were availed to audit. | No. The output was not reported on in the Annual performance report ||  
...
| Civil || Boundary marking phase 4 | yes | 64km railway reserve land secured by physical markers | 1,000,000 | nil | nil | 51,000 | Boundary markers erected | Could not be ascertain ed | Partially Implemented | No. No monitoring reports were availed to audit. | No, The kilometers covered by the boundary marker not specified in the report ||  
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|  
| IT | 312213 ICT equipme nt | Networking | yes | URC station integrated on to one Wide Area Network | 909,580 | nil | nil | 0 | it was not undertaken | URC station integrate d on to one Wide Area Network. This was not undertak en. | Not implemented | No. No monitoring reports were availed to audit. | No. The output was not reported on in the Annual performance report | Computer supplies - UGX 16M, CCTV and computer s- UGX 163M, Budgeting tool -UGX 75M, Telecom expenditu re -UGX 285M  paid outside the budget. |  
...
| IT || Intercom | yes | URC stations connected to one intercom | 55,500 | nil | nil | 0 | it was not undertaken | URC stations connected to one intercom. This was not undertaken | Not implemented | No. No monitorin g reports were availed  to audit. | No. The output was not reported on in the Annual performance report ||  
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|  
| IT |^| PBX | yes | URC stations connected to one PBX | 74,000 | nil | nil | 0 | it was not undertaken | URC stations connected to one PBX. This was not undertaken | Not implemented | No. No monitorin g reports were availed  to audit. | No. The output was not reported on in the Annual performance report ||  
| IT |^| LAN radios | yes | LAN Radios integrated | 34,595 | nil | nil | 0 | it was not undertaken | LAN Radios integrated. This was not undertaken. | Not implemented | No. No monitorin g reports were availed  to audit. | No. The output was not reported on in the Annual performance report ||  
| Civil | 312101 Land  and buildings | Tororo Loco shade | yes | One building repaired | 504,679 | nil | nil | 0 | it was not undertaken | One building repaired. This was not undertaken | Not implemented | No. No monitorin g reports were availed  to audit. | No. The output was not reported on in the Annual performance report ||  
| Civil |^| Kla station fencing | No | Fence erected over Kampala headquart er land | 727,019 | nil | nil | 0 | it was not undertaken | Fence erected  over Kampala headquarter land was not undertaken | Not implemented | No. No monitorin g reports were availed  to audit. | No. The output was not reported on in the Annual performance report | Kampala good  shed repaired at UGX 103M, Mukono ICD roof repaired at 249M, and dpf stores repaired at 67M all outside the budget of |  
...
|| 19/20. |  
|---|---|  
| Civil || Station sanitary improvemen t | no | Various stations and estates sanitary facilities repaired | 142,423 | nil | nil | 0 | it was not undertaken | Various stations and estates sanitary facilities repaired were not undertaken | Not implemented | No. No monitorin g reports were availed  to audit. | No. The output was not reported on in the Annual performance report ||  
| Civil || Portbell mechanical workshop | yes | one building repaired | 57,697 | nil | nil | 5,600 | Port bell ware house repaired | 0 | fully implemented | No. No monitorin g reports were availed  to audit. | No ||  
| Cicil || Portbell pier winch guide and timber | no | Pier guide and timber replaced | 35,922 | nil | nil | 0 | it was not undertaken | Pier guide and timber replaced. This was not undertaken | Not implemented | No. No monitorin g reports were availed  to audit. | No. The output was not reported on in the Annual performance report | . Jinja pier repaired at 386 M outside the budget. |  
| Mechanical || Elect installations | no | Electrical installation s done | 228,000 | nil | nil | 0 | it was not undertaken | Electrical installations done. This was not undertaken | Not implemented | No. No monitorin g reports were availed  to audit. | No. The output was not reported on in the Annual performance report ||  
| Operations || Birth expansion | no | Birth area over portbell dredged | 700,000 | nil | nil | 0 | it was not undertaken | Birth area over port bell dredged. This was not undertaken | Not implemented | No. No monitorin g reports were availed  to audit. | No. The output was not reported on in the Annual performance report ||  
...
| Managing Director || Reception area re- modelling | yes | One reception at headquart er building remodeled | 30,000 | nil | nil | 0 | it was not undertaken | One reception at headquarter building remodeled. This was not undertaken | Not implemented | No. No monitorin g reports were availed  to audit. | No. The output was not reported on in the Annual performance report ||  
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|  
| Operations | 312201 Motor Vehicles | Double cabin pick up | yes | 1 double cabin pick up purchased | 150,000 | nil | nil | 0 | it was not undertaken | 1 double cabin pick up purchased. This was not undertaken | Not implemented | No. No monitorin g reports were availed  to audit. | No. The output was not reported on in the Annual performance report ||  
| Operations |^| Motorcycles | yes | 6 motorcycle s purchased | 120,000 | nil | nil | 0 | it was not undertaken | 6 motorcycles purchased. This was not undertaken. | Not implemented | No. No monitorin g reports were availed  to audit. | No. The output was not reported on in the Annual performance report ||  
| Operations |^| Mini-bus | yes | 2 mini- buses purchased | 200,000 | nil | nil | 0 | it was not undertaken | 2 mini- buses purchased. This was not undertaken. | Not implemented | No. No monitorin g reports were availed  to audit. | No. The output was not reported on in the Annual performance report ||  
| Operations |^| Pickups | yes | 3 pickups purchased | 400,000 | nil | nil | 0 | it was not undertaken | 3 pickups purchased. This was not undertaken. | Not implemented | No. No monitorin g reports were availed  to audit. | No. The output was not reported on in the Annual performance report ||  
| Mechanical |^| Mini-lorry/ tipper | yes | I tipper purchased | 304,000 | nil | nil | 0 | it was not undertaken | I tipper purchased. This was not undertaken. | Not implemented | No. No monitorin g reports were availed  to audit. | No. The output was not reported on in the Annual performance report ||  
